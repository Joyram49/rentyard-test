...
interface NearestLandmarkFormProps {
  initialData: NearestLandmark | null;
  setFormData: (
    updater: (prev: NearestLandmark[]) => NearestLandmark[]
  ) => void;
  closeModal: () => void;
}
