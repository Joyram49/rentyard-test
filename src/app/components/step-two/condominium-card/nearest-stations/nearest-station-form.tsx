...
interface NearestStationFormProps {
  initialData: NearestStation | null;
  setFormData: (updater: (prev: NearestStation[]) => NearestStation[]) => void;
  closeModal: () => void;
}
